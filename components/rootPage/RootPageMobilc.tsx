...
const RootPageMobilc = ({
  ...
  return (
    <div
      className={`sm:pt-40 w-full h-[82%] flex flex-col items-center gap-2 font-mono ${
    ...
    >
      ...
      <div className={`text-white w-full h-auto px-5 flex flex-col gap-7`}>
      ...
      <div className="w-full flex flex-row justify-between px-5  items-center">
        ...
        <div className=" flex flex-row gap-5 mt-5 mb-5 justify-start">
          <FaLinkedin
            onClick={() =>
