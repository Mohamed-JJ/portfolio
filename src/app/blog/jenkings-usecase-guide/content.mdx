...
export const meta = {
  ...
  image:
    "/readings/jenkins.png",
  tags: ["jenkins", "CI/CD", "DevOps"],
  externalLink: "https://medium.com/@simojarboue24/jenkins-a-comprehensive-guide-for-personal-and-professional-use-2fe3c9e2831e",
};
