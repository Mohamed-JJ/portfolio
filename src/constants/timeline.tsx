export const timeline = [
  {
    company: "Mapping Technologies",
    title: "Software Engineer",
    date: "2025 - Present",
    description: "Development over areas",
    responsibilities: [
  ...
  {
    company: "LeetOps club",
    title: "Lead DevOps Engineer",
    date: "2024 - present",
    description: "Shapping the future 1337/42 devops engineers",
    responsibilities: [
  ...
  },
  {
    ...
    date: "2025 - 2025",
    description: "Cloud research and audit",
    responsibilities: [
  ...
  },
  {
    ...
    date: "2024 - 2024",
    description: "Building a smart assistant",
    responsibilities: [
...

  {
    ...
    date: "2024 - 2024",
    description: "System security audit and reinforcement",
    responsibilities: [
  ...
  },
  {
    ...
    title: "Software Engineer",
    date: "2024 - 2025",
    description: "AI integration to Client's workflow",
    responsibilities: [
      "Improved the Windows operating system to enhance user experience",
      "Developed a new feature that personalizes user interface",
      "Enhanced the office suite to improve productivity",
  ...
  },
  {
    ...
    date: "2022 - 2023",
    description: "Building a brand, one client at a time",
    responsibilities: [
      "Improved the Windows operating system to enhance user experience",
      "Developed a new feature that personalizes user interface",
      "Enhanced the office suite to improve productivity",
